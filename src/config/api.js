...
export default class Api {
  ...
  initialize() {
    ...
    localeLang = localeLang === "en-US" ? "en" : localeLang

    this.axios.defaults.headers.common["Accept"] = "application/json"
    this.axios.defaults.headers.common["Accept-Language"] = localeLang
  ...
  get(path, params, options) {
    return this.axios.get(path, { params, ...options }).catch((error) => {
      throw error
    })
  }
  ...
  patch(path, data) {
    ...
    return this.axios.patch(path, data, headers).catch((error) => {
      throw error
    })
  }
